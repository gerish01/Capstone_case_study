...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('tracker', '0003_remove_task_assigned_users_remove_userrole_has_tasks'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='task',
            name='assigned_to',
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='tasks', to='tracker.customuser'),
        ),
        migrations.AlterField(
            model_name='project',
            name='owner',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='tracker.customuser'),
        ),
        migrations.AlterField(
            model_name='task',
            name='owner',
        ...
        migrations.AlterField(
            model_name='userrole',
            name='user',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='tracker.customuser'),
        ),
    ]
